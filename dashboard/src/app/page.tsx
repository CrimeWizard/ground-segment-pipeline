  ...
  return (
    <main className="min-h-screen bg-background text-foreground font-mono selection:bg-orange-500/30 transition-colors duration-300">
      ...
      <nav className="border-b border-border-ui bg-surface/50 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-lg font-bold tracking-tighter text-header uppercase">Orbital Freight Intel</span>
          </div>
          
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-2 text-[10px] uppercase tracking-[0.2em] text-muted-ui">
            ...
            <div className="flex items-center gap-2">
              ...
              <select 
                ...
                className="bg-transparent text-[10px] uppercase tracking-widest font-bold text-foreground focus:outline-none cursor-pointer hover:text-orange-600 transition-colors"
              >
                {locations.map(loc => (
                  <option key={loc} value={loc} className="bg-surface text-foreground">{loc}</option>
                ))}
              </select>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        {error ? (
          <div className="bg-red-500/10 border border-red-500/50 p-8 rounded-lg flex items-center gap-4 text-red-600 dark:text-red-400">
